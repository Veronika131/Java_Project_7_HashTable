 ...
 *
 * @author Foothill College, Bita M, Veronika Cabalova Joseph
 */
public class MyTunes 
{
	...
	public static void main(String[] args) 
	{
		...
		//final String TESTFILE01 = "resources/findNonexistentIDs.txt"; 	// Example test file for hashing based on nonexistent IDs
		//final String TESTFILE02 = "resources/findNonexistentGenres.txt";  	// Example test file for hashing based on nonexistent genres names

		//final String TESTFILE01 = "resources/findRepeatedIDs.txt";	// Example test file for hashing based on repeated IDs
		//final String TESTFILE02 = "resources/findRepeatedGenres.txt";	// Example test file for hashing based on repeated genres names

		//final String TESTFILE01 = "resources/findEmptyIDs.txt";	// Example test file for hashing based on empty IDs
		//final String TESTFILE02 = "resources/findEmptyGenres.txt";	// Example test file for hashing based on empty genres names
